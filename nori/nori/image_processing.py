...
def image_opening(image, radius, iterations=4):
    """
    ...
    """
    kernel = create_circular_se(radius)
    opened_image = cv.morphologyEx(image, cv.MORPH_OPEN, kernel, iterations=iterations)
    return opened_image
