"""
This script is used to filter the ilastik segmentation output to get the individual substructures.
The ilastik segmentation output is a 3-channel image where each channel represents a different substructure.
The script filters the substructures and saves them as individual images.
"""

from typing import List, Tuple
from nori.image_processing import filter_nuclei, filter_bb, filter_lumen
from nori.utils import read_file_names
import cv2 as cv
